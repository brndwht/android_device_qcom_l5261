...
#ifndef RFDEVICE_PA_SKY_77648_DATA_AG
#define RFDEVICE_PA_SKY_77648_DATA_AG
...
$Header: //Commercial/MPSS.DPM.2.0.2.c1/Main/modem_proc/rfdevice_pa/src/rfdevice_pa_sky_77648_data_ag.h#1 $ 
...
class rfdevice_pa_sky_77648_data_ag:public rfdevice_pa_data
{
public:
    ...
    ~rfdevice_pa_sky_77648_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_pa_sky_77648_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_pa_data *rfdevice_pa_sky_77648_data_ptr;
