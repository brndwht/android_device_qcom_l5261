...
rfc_device_info_type rf_card_wtr4905_china_v2_tx0_lte_b2_device_info = 
{
  ...
  7,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x0217 << 22)/*mfg_id*/ | (0x26 << 14)/*prd_id*/ | (29)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
...
rfc_device_info_type rf_card_wtr4905_china_v2_tx0_lte_b4_device_info = 
{
  ...
  7,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x0217 << 22)/*mfg_id*/ | (0x26 << 14)/*prd_id*/ | (31)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
  ...
  {
    {
      ...
      {
        0 /*Warning: Not specified*/,  /* INTF_REV */
        (int)WTR4905_LTEFDD_DRXLGY1_BAND5_DLB3,  /* PORT */
        ( RFDEVICE_PA_LUT_MAPPING_INVALID ),  /* RF_ASIC_BAND_PA_LUT_MAP */
        FALSE,  /* TXAGC_LUT */
        WTR4905_FBRX_ATTN_DEFAULT,  /* FBRX_ATTN_STATE */
        0,  /* Array Filler */
...
rfc_device_info_type rf_card_wtr4905_china_v2_rx0_lte_b17_device_info = 
{
  ...
  4,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x1B0 << 22)/*mfg_id*/ | (0x02 << 14)/*prd_id*/ | (3)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
...
rfc_device_info_type rf_card_wtr4905_china_v2_rx1_lte_b17_device_info = 
{
  ...
  2,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x020C << 22)/*mfg_id*/ | (0x81 << 14)/*prd_id*/ | (1)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
