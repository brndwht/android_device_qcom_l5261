...
rfc_signal_info_type rfc_wtr4905_china_v2_sig_info[RFC_WTR4905_CHINA_V2_SIG_NUM + 1] = 
{
  ...
  //BEGIN <modem> <DATA20150904> <multiple band> limi.zhang
  #if 0 //defined(FEATURE_OSMB) //Tinno:CJ  gpio config for OSMB
  { RFC_MSM_RFFE2_CLK                       , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioSignalType)NULL }, /* RFC_WTR4905_CHINA_V2_RFFE2_CLK */ 
  { RFC_MSM_RFFE2_DATA                      , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioSignalType)NULL }, /* RFC_WTR4905_CHINA_V2_RFFE2_DATA */ 
  #else
  ...
  #endif
  //END <modem> <DATA20150904> <multiple band> limi.zhang
