...
#ifndef RFDEVICE_PA_SKY_77781_DATA_AG
#define RFDEVICE_PA_SKY_77781_DATA_AG
...
$Header: //Commercial/MPSS.DI.2.0.1.c1/Main/modem_proc/rfdevice_pa/src/rfdevice_pa_sky_77781_data_ag.h#2 $ 
...
class rfdevice_pa_sky_77781_data_ag:public rfdevice_pa_data
{
public:
    ...
    ~rfdevice_pa_sky_77781_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_pa_sky_77781_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_pa_data *rfdevice_pa_sky_77781_data_ptr;
