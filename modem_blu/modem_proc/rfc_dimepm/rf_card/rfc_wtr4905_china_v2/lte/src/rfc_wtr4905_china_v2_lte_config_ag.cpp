...
extern "C" 
{
  ...
  extern rfc_device_info_type rf_card_wtr4905_china_v2_rx0_lte_b12_device_info;
  extern rfc_sig_info_type rf_card_wtr4905_china_v2_rx0_lte_b12_sig_cfg;
  extern rfc_device_info_type rf_card_wtr4905_china_v2_rx1_lte_b12_device_info;
  extern rfc_sig_info_type rf_card_wtr4905_china_v2_rx1_lte_b12_sig_cfg;
  extern rfc_device_info_type rf_card_wtr4905_china_v2_tx0_lte_b12_device_info;
  extern rfc_sig_info_type rf_card_wtr4905_china_v2_tx0_lte_b12_sig_cfg;
...
boolean rfc_wtr4905_china_v2_lte_ag::sig_cfg_data_get( rfc_cfg_params_type *cfg, rfc_sig_cfg_type **ptr )
{
  ...
  *ptr = NULL;
  ...
  { *ptr = &(rf_card_wtr4905_china_v2_rx0_lte_b12_sig_cfg.cfg_sig_list[0]);  ret_val = TRUE; }
  ...
  { *ptr = &(rf_card_wtr4905_china_v2_rx1_lte_b12_sig_cfg.cfg_sig_list[0]);  ret_val = TRUE; }
  ...
  { *ptr = &(rf_card_wtr4905_china_v2_tx0_lte_b12_sig_cfg.cfg_sig_list[0]);  ret_val = TRUE; }
...
boolean rfc_wtr4905_china_v2_lte_ag::devices_cfg_data_get( rfc_cfg_params_type *cfg, rfc_device_info_type **ptr )
{
  ...
  *ptr = NULL;
  ...
  { *ptr = &(rf_card_wtr4905_china_v2_tx0_lte_b8_device_info);  ret_val = TRUE; }
   ...
   if ( ( cfg->rx_tx == RFC_CONFIG_RX ) && ( cfg->logical_device == RFM_DEVICE_0 ) && ( cfg->alternate_path == 0 /*Warning: not specified*/ ) && ( cfg->band == (int)RFCOM_BAND_LTE_B12 ) && ( cfg->req == RFC_REQ_DEFAULT_GET_DATA ) && !ret_val )
  { *ptr = &(rf_card_wtr4905_china_v2_rx0_lte_b12_device_info);  ret_val = TRUE; }

  if ( ( cfg->rx_tx == RFC_CONFIG_RX ) && ( cfg->logical_device == RFM_DEVICE_1 ) && ( cfg->alternate_path == 0 /*Warning: not specified*/ ) && ( cfg->band == (int)RFCOM_BAND_LTE_B12 ) && ( cfg->req == RFC_REQ_DEFAULT_GET_DATA ) && !ret_val )
  { *ptr = &(rf_card_wtr4905_china_v2_rx1_lte_b12_device_info);  ret_val = TRUE; }

  if ( ( cfg->rx_tx == RFC_CONFIG_TX ) && ( cfg->logical_device == RFM_DEVICE_0 ) && ( cfg->alternate_path == 0 /*Warning: not specified*/ ) && ( cfg->band == (int)RFCOM_BAND_LTE_B12 ) && ( cfg->req == RFC_REQ_DEFAULT_GET_DATA ) && !ret_val )
  { *ptr = &(rf_card_wtr4905_china_v2_tx0_lte_b12_device_info);  ret_val = TRUE; }
